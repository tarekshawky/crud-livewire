                ...
                <div>
                    <form wire:submit="store">
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input wire:model="name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input wire:model="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-12">
                                ...
                                <div class="flex">
                                    ...
                                    <input wire:model="password" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                        ...
                        <div class="flex -mx-3">
                            ...
                            <div>
                                <button wire:navigate href="/login">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
